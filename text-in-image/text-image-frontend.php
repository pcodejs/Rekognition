 ...
 * 
 * =============================================================================
 * Original Filename: text-image-frontend.php
		...
		<div class="container-fluid" id="box">
			...
			<div class="row no-gutters">
				...
				<div id="outer-wrapper" >
					...
					<h3>Text in Image</h3>
					<h5><span>Amazon Rekognition</span> can automatically detects and extracts text in your images</h5>
	

					<!-- MAIN FORM -->
					<form id="text-image" action="text-image-backend.php" method="post" enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-md-5">
								...
								<!-- ACTION BUTTON -->
								<div id="action">
									<button onclick="downloadRekognitionResults()">Download Text</button>
								</div>
							...
							<div class="col-md-7">
								...
								<div id="image-holder">
									<div id="image-wrapper">				
										...
										<img id="image" src="../distr/img/tm2-large.jpg" alt="Main Image">
								...
								<div id="image-utilities" class="row">
									...
									<div id="sample-image" class="col-md-6">
										...
										<a href="" class="img-thumb"><img src="../distr/img/tm1-large.jpg" alt="Demo Image"></a>

										<a href="" class="img-thumb active"><img src="../distr/img/tm2-large.jpg" alt="Demo Image"></a>

										<a href="" class="img-thumb"><img src="../distr/img/tm3-large.jpg" alt="Demo Image"></a>
