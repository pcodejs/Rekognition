 ...
 * 
 * =============================================================================
 * Original Filename: image-moderation-frontend.php
		...
		<div class="container-fluid" id="box">
			...
			<div class="row no-gutters">
				...
				<div id="outer-wrapper" >
					...
					<h5><span>Amazon Rekognition</span> automatically detects explicit or suggestive adult content, or violent content in your images, and provides confidence scores</h5>
	

					<!-- MAIN FORM -->
					<form id="image-moderation" action="image-moderation-backend.php" method="post" enctype="multipart/form-data">
							...
							<div class="col-md-7">
								...
								<div id="image-holder">
									<div id="image-wrapper">
										...
										<div id="image-buttons">
											<button id="image-view">View Content</button>
											<button id="image-blur">Blur Content</button>
										</div>	

										<canvas id="canvas"></canvas>
										
										<img id="image" class="moderation" src="../distr/img/im2-large.jpg" alt="Main Image">
								...
								<div id="image-utilities" class="row">
									...
									<div id="sample-image" class="col-md-6">
										...
										<h6>Try with Sample Images</h6>

										<a href="" class="img-thumb"><img src="../distr/img/im1-large.jpg" alt="Demo Image"></a>

										<a href="" class="img-thumb active"><img src="../distr/img/im2-large.jpg" alt="Demo Image"></a>

										<a href="" class="img-thumb"><img src="../distr/img/im3-large.jpg" alt="Demo Image"></a>
