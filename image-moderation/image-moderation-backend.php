 ...
 * 
 * =========================================================================
 * Original Filename: image-moderation-backend.php
 ...
 */
	...
	if (isset($_FILES['file'])) {
		...
		if ($s3_status === 200) {
			...
			$result = $rekognition->imageModeration($file_name);
			...
			if ($result_status === 200) {
				...
				json_output($result['ModerationLabels']);				
	...
	if(isset($_POST['demo-image'])){
	    ...
	    # Call imageModerationLocalFileSystem() and pass bytes of the image
		$result = $rekognition->imageModerationLocalFileSystem($image);
