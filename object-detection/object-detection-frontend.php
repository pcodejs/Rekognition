 ...
 * 
 * =============================================================================
 * Original Filename: object-detection-frontend.php
		...
		<div class="container-fluid" id="box">
			...
			<div class="row no-gutters">
				...
				<div id="outer-wrapper" >
					...
					<h3>Object and scene detection</h3>
					<h5><span>Amazon Rekognition</span> can automatically label objects, concepts and scenes in your images, and also provides a confidence score</h5>
	

					<!-- MAIN FORM -->
					<form id="object-detection" action="object-detection-backend.php" method="post" enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-md-5">
								...
								<!-- ACTION BUTTON -->
								<div id="action">
									<button onclick="downloadRekognitionResults()">Download List</button>
								</div>
							...
							<div class="col-md-7">
								...
								<div id="image-holder">
									<div id="image-wrapper">
										...
										<img id="image" src="../distr/img/od2-large.jpg" alt="Main Image">
								...
								<div id="image-utilities" class="row">
									...
									<div id="sample-image" class="col-md-6">
										...
										<a href="" class="img-thumb"><img src="../distr/img/od1-large.jpg" alt="Demo Image"></a>

										<a href="" class="img-thumb active"><img src="../distr/img/od2-large.jpg" alt="Demo Image"></a>

										<a href="" class="img-thumb"><img src="../distr/img/od3-large.jpg" alt="Demo Image"></a>
