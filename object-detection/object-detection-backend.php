 ...
 */
	...
	if (isset($_FILES['file'])) {
		...
		if ($s3_status === 200) {
			...
			$result = $rekognition->objectDetection($file_name);
	...
	if(isset($_POST['demo-image'])){
	    ...
	    # Call objectDetectionLocalFileSystem() and pass bytes of the image
		$result = $rekognition->objectDetectionLocalFileSystem($image);
