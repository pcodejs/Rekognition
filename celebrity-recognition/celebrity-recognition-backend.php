 ...
 * 
 * =========================================================================
 * Original Filename: celebrity-recognition-backend.php
 ...
 */
	...
	if (isset($_FILES['file'])) {
		...
		if ($s3_status === 200) {
			...
			$result = $rekognition->celebrityRecognition($file_name);
			...
			if ($result_status === 200) {
				...
				json_output($result['CelebrityFaces']);				
	...
	if(isset($_POST['demo-image'])){
	    ...
	    # Call celebrityRecognitionLocalFileSystem() and pass bytes of the image
		$result = $rekognition->celebrityRecognitionLocalFileSystem($image);
