 ...
 * 
 * =============================================================================
 * Original Filename: celebrity-recognition-frontend.php
					...
					<form id="celebrity-recognition" action="celebrity-recognition-backend.php" method="post" enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-md-5">
								...
								<!-- ACTION BUTTON -->
								<div id="action">
									<button onclick="downloadRekognitionResults()">Download Info</button>
								</div>
							...
							<div class="col-md-7">
								...
								<div id="image-holder">
									<div id="image-wrapper">
										...
										<img id="image" src="../distr/img/cr3-large.jpg" alt="Main Image">
								...
								<div id="image-utilities" class="row">
									...
									<div id="sample-image" class="col-md-6">
										...
										<a href="" class="img-thumb"><img src="../distr/img/cr1-large.jpg" alt="Demo Image"></a>

										<a href="" class="img-thumb"><img src="../distr/img/cr2-large.jpg" alt="Demo Image"></a>

										<a href="" class="img-thumb active"><img src="../distr/img/cr3-large.jpg" alt="Demo Image"></a>
