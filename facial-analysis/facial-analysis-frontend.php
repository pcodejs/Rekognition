 ...
 * 
 * =============================================================================
 * Original Filename: facial-analysis-frontend.php
		...
		<div class="container-fluid" id="box">
			...
			<div class="row no-gutters">
				...
				<div id="outer-wrapper" >
					...
					<h5>Get a complete analysis of facial attributes, including confidence scores</h5>
	

					<!-- MAIN FORM -->
					<form id="facial-analysis" action="facial-analysis-backend.php" method="post" enctype="multipart/form-data" name="facial-analysis">
							...
							<div class="col-md-7">
								...
								<div id="image-holder">
									<div id="image-wrapper">
										...
										<img id="image" src="../distr/img/fa1-large.jpg" alt="Main Image">										
								...
								<div id="image-utilities" class="row">
									...
									<div id="sample-image" class="col-md-6">
										...
										<a href="" class="img-thumb active"><img src="../distr/img/fa1-large.jpg" alt="Demo Image"></a>

										<a href="" class="img-thumb"><img src="../distr/img/fa2-large.jpg" alt="Demo Image"></a>

										<a href="" class="img-thumb"><img src="../distr/img/fa3-large.jpg" alt="Demo Image"></a>
